...
int newAdventurer(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int temphand[], int z) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus) {
    ...
    switch (card) {
        case adventurer:
            newAdventurer(drawntreasure, state, currentPlayer, cardDrawn, temphand, z);
        ...
        case remodel:
            newRemodel(j, state, currentPlayer, choice1, choice2, handPos, i);

        case smithy:
            newSmithy(i, currentPlayer, state, handPos);
        ...
        case steward:
            newSteward(choice1, currentPlayer, state, choice2, choice3, handPos);
        ...
        case cutpurse:
            newCutPurse(currentPlayer, state, i, j, k, handPos);
